<template>
  ...
  <div class="answer-model-shadow" v-if="questionShow && !btns[route.query.id]['Y']">
    <div class="answer-model">
      ...
      <div class="btn-group">
        <a-button type="primary" @click="toTargetJump(1)">Try again</a-button>
        <a-button type="primary" @click="model.jumpTo('/dashboard')"> Learn More </a-button>
      </div>
    </div>
  </div>
